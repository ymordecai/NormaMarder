...
import aboutImg7 from 'root/public/partials/about/Norma-Herbert-Nov-2022.jpg'
...
<h5><center>* * *</center></h5>
<h5>In Spanish, the word <em>derecho</em> has several meanings. It can mean, "right side," or "correct" or a “human right.” It also means “straight ahead” and also "upright" and "direct." In English, a <em>derecho</em> is a rare kind of powerful storm with intense thunderstorms and strong winds pushing in straight lines, as opposed to a <em>tornado</em> in which the winds turn and twist. </h5>

<h5>And so, in the early afternoon of June 29 suddenly there was no more time. As our mother's life surged up to its final crest, a violent storm came barreling through the Illinois prairie, pushing straight across the flat ocean of corn and soy, so different from the steep hills and valleys of the Pennsylvania steel town where she grew up.</h5>

<h5>This powerful storm with its straight line of thunderstorms came smashing into our small city, pulling down trees, bringing down power lines, with furious thunder and lightning, charging the atmosphere with force and electricity. As Michael and I sat on opposite sides of the country, the caregiver raced to bring our father, fragile and disoriented, to the hospital as our mother lapsed into unconsciousness.</h5>

<h5>And as this derecho passed directly overhead, our mother became a leaf on the wind, passed out of her body, and left this earth.</h5>

        </div>
        <div className='_description'><h5>— Yuri Marder</h5></div>
      </Col>
